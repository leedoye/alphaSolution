...
<body>
 ...
 %></td>
	...
	<!-- 여기는 자신의 관리와 기능을 적을것 -->
	<h6>교육센터 통합 운영관리 시스템 - 모임방 - 모임방 참여신청</h6>
	...
	<div align="center">
		<form action="CommunityParticipantRequest.jsp">
			<table width="600px" cellpadding="1">
			
				<tr>
					<td align=left>모임방 명</td>
					<td align=left><%=community.communityName%></td>
				</tr>
				
				<tr><td>&nbsp;</td><td>&nbsp;</td></tr>
				
				<tr>
					<td align=left>모임방 설명</td>
					<td align=left><%=community.communityExplanation %></td>
				</tr>
				
				<tr>
					<td colspan=2 align="center">
						<input type="hidden" name=communityNo value=<%=community.communityNo%>>
						<input type="submit" class="myButton" value="참여 신청" >
